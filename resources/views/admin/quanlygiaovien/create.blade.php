...
<div class="card-body pad">
    ...
    @endif
    <form action="{{ route('admin.quanlygiaovien.store')}}" id="register" method="POST">
    @csrf             
        ...
        <div class="card-footer" style="padding: 0">
            <a href="{{ route('admin.quanlygiaovien.index')}}" class="btn btn-secondary" style="font-size: .875rem;">Quay lại</a>
