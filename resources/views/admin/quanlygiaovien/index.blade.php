                        ...
                        @if(isset($giaovien))
                            @foreach($giaovien as $gv)
                                <tr>
                                    ...
                                    <td>{{$gv->rolename}}</td>
                                    <td>
                                        <a href="{{ route('admin.chuyennganh.edit', $gv->id)}}" class="btn btn-xs btn-primary"><i class="fas fa-pencil-alt"></i> Sửa</a>
                                        <a href="{{ route('admin.chuyennganh.delete', $gv->id)}}" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i> Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
